...
import {
  ...
  MapPin, Menu, ShieldCheck, Sparkles, Star, Wrench, X,
} from "lucide-react";
...
const services = [
  ...
  { title: "Pipe Repair", text: "Professional solutions for damaged or leaking pipes.", icon: Wrench },
